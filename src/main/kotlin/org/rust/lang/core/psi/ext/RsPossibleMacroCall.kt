...
private fun doPrepareProcMacroCallBody(
    ...
    return when (val attr = ProcMacroAttribute.getProcMacroAttributeRaw(owner, stub, explicitCrate)) {
...
private val RsAttrProcMacroOwner.firstKeyword: PsiElement?
...
private fun RsPossibleMacroCall.textIfNotExpanded() = when (val kind = kind) {
    is MacroCall -> text
