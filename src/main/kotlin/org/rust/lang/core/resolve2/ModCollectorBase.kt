...
class ModCollectorBase private constructor(
    ...
    private fun collectAttrProcMacroCall(
        ...
        val originalItem = if (item is RsNamedStub && RsProcMacroPsiUtil.canFallbackItem(item)) {
...
fun StubElement<*>.hasMacroIndex(crate: Crate): Boolean =
    hasMacroIndexIgnoringProcMacros() || this is RsAttrProcMacroOwnerStub
        && ProcMacroAttribute.getProcMacroAttributeRaw(this.psi as RsAttrProcMacroOwner, this, crate) is ProcMacroAttribute.Attr
...
fun PsiElement.hasMacroIndex(crate: Crate): Boolean =
    this is RsMacroCall || this is RsMacro || this is RsModItem || this is RsModDeclItem || this is RsAttrProcMacroOwner
        && ProcMacroAttribute.getProcMacroAttributeRaw(this, explicitCrate = crate) is ProcMacroAttribute.Attr
