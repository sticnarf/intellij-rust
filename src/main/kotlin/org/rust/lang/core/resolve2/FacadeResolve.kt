...
fun RsMetaItem.resolveToProcMacroWithoutPsi(): ProcMacroDefInfo? {
    val resolvedMacro = resolveToProcMacroWithoutPsiUnchecked(checkIsMacroAttr = true)
        ?: return null
    if (resolvedMacro.props.treatAsBuiltinAttr) return null
    return resolvedMacro
}

fun RsMetaItem.resolveToProcMacroWithoutPsiUnchecked(checkIsMacroAttr: Boolean): ProcMacroDefInfo? {
