...
class CfgDisabledOrAttrProcMacroTest : RsTestBase() {
    ...
    private fun doTest(@Language("Rust") code: String) {
        ...
        val expectedCS = CfgDisabledOrAttrProcMacro.values().find { it.name == data }!!
